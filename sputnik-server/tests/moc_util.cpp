...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_NetworkUtil_t, stringdata) + ofs \
...
const QMetaObject NetworkUtil::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NetworkUtil.data,
      qt_meta_data_NetworkUtil,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NetworkUtil.stringdata))
        return static_cast<void*>(const_cast< NetworkUtil*>(this));
