...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Test1_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 32, 15)
    ...
    "Test1\0initTestCase\0\0test1\0test2\0"
    "cleanupTestCase\0"
};
...
const QMetaObject Test1::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Test1.data,
      qt_meta_data_Test1,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Test1.stringdata))
